...
function Register(props) {
  ...
  }, [props.message]); //put an empty array as second parameter will ensure the useEffect only run once.
    ...
    <div className="register">
      ...
      <div>
        <form onSubmit={submit}>
          <label htmlFor="username">Username (6-12 characters):</label>
          <br />
          <input
            type="text"
            id="username"
            ...
            pattern=".{6,12}"
            title="6 to 12 characters are required"
            required
          ></input>
          <br />
          <br />
          <label htmlFor="password1">Password (6-18 characters):</label>
          <br />
          <input
            type="password"
            id="password1"
            ...
            pattern=".{6,18}"
            title="Password can not be less than 6 character or more than 18 characters"
            required
          ></input>{' '}
          <br /> <br />
          ...
          ></input>{' '}
          <br /> <br />
          <button type="submit" style={{ background: 'rgb(203, 233, 252)' }}>
            Submit
          </button>
          <button
            type="button"
            onClick={goBack}
            style={{ background: 'rgb(203, 233, 252)' }}
          >
            Back
          </button>
